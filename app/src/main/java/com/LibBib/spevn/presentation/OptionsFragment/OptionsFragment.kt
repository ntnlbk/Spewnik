...
import com.LibBib.spevn.databinding.FragmentOptionsBinding
    ...
    private fun setupOnClickListeners() {
        ...
        binding.changeColorIv.setOnClickListener {
            ColorPickerDialog.Builder(requireActivity())
                ...
                .setPositiveButton(getString(com.LibBib.spevn.R.string.confirm),
                    ColorEnvelopeListener { envelope, _ -> viewModel.setColor(envelope.color) })
                .setNegativeButton(
                    getString(com.LibBib.spevn.R.string.cancel)
